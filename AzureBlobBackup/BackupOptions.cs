...
namespace AzureBlobBackup
{
    ...
    public class BackupOptions
    {
          ...
          [Option('t', "throttle", DefaultValue = 0, HelpText = "Limit number of concurrent tasks, default set to the number of cores on the system")]
          ...
          [Option('x', "delete", MutuallyExclusiveSet = "bclr", HelpText = "Deletes destination container (including blobs in it). Requires confirmation.")]
          ...
          public string GetUsage()
          {
              ...
              {
                  Heading = new HeadingInfo("AzureBlobBackup.exe", "Azure Blob Backup Utility"),
                  AdditionalNewLineAfterOption = true,
                  AddDashesToOption = true
              };

              help.AddPreOptionsLine("");
              help.AddPreOptionsLine("Usage: AzureBlobBackup.exe -b -s <source path> -d <container>");
